...
- Imperativo se preucupa no como, vai definir passo a passo de como atingir o
  objetivo
- Declarativo se preocupa com "o que", apenas diz o que quer, e não importa mto
  o que a api ou linguagem vai fazer por baixo pra atingir esse "o que"
- Muitos (se não todos) dos approaches declarativos usam abstrações imperativas
  por baixo dos panos

### React e React Dom

São libs separadas, uma vez que React funciona cross plataforma, então a lib
React pode ser usada para React Native, web, vr, etc. E quando usamos web, o
ReactDOM renderiza os elementos usando a API do DOM.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=contato%40otaciliomaia.com).
